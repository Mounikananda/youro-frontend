        ...
        <Sidebar backgroundColor="#9CB189" className='Side-bar' collapsed={collapse}>
          ...
          >
            ...
            <Tooltip title={<p style={{ margin: "2px", fontSize: "12px" }}>Home</p>} placement="right-start" enterDelay={100} leaveDelay={100} followCursor TransitionComponent={Zoom} disableFocusListener disableTouchListener>
              <MenuItem onClick={() => navigate("/doctor-home")} icon={<FaHome size={40} />} active={props.data === 'doctor-home'} className="Menu-item" >Home</MenuItem>
            </Tooltip>
            ...
            <Tooltip title={<p style={{ margin: "2px", fontSize: "12px" }}>Patient Details</p>} placement="right-start" enterDelay={100} leaveDelay={100} followCursor TransitionComponent={Zoom} disableFocusListener disableTouchListener>
