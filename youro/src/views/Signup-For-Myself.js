  ...
  return (
    <div>
      {step === 0 && (
        <>
          <form
            class="SignupMyself-container"
            onSubmit={handleSubmit(onsubmit)}
          >
            <h1>youro</h1>
            <p className="h3">
              Membership/Sign-up gives you direct access to our team of
              <br /> urological providers with same or next day appointments.{" "}
            </p>
            <div className="Form-myself-Container">
              ...
              <div className="required-fields">
                <div className="myself-input">
                  <label>Email *</label>
                  <input
                    className="input-field1 input-border"
                    type="text"
                    {...register("email", {
                      required: true,
                      maxLength: 32,
